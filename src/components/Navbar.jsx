    ...
    <header className="fixed inset-x-0 top-0 z-50">
      <div className="bg-white shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
        ...
        <div className="border-t border-border bg-brand-light">
          <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-2 text-xs text-brand-dark sm:flex-row sm:items-center sm:justify-between">
            <div className="min-w-0">
              <span className="font-medium">🛠</span> <span className="italic">{noteText}</span>
            </div>
            <a
              href="tel:+40722648175"
              className="inline-flex items-center justify-center rounded-full border border-border bg-white px-3 py-1 font-semibold text-text-dark transition hover:bg-cream"
            >
              +40 0722 648 175
            </a>
          </div>
